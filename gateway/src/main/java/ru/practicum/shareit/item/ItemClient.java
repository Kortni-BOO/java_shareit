...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object>  createItem(ItemDto itemDto, long id) {
        return post("", id, itemDto);
    }

    public ResponseEntity<Object> updateItem(ItemDto itemDto, long id, long itemId) {
    ...
    public ResponseEntity<Object> getAllByUserId(long id, int from, int size) {
    ...
    public ResponseEntity<Object> search(String text, int from, int size) {
        ...
        return get("/search?size={size}&from={from}&text={text}", null, parameters);
    }
