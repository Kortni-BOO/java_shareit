...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    **PAST** (англ. «завершённые»),
    ...
    //получение всех текущих бронирований пользователя
    //отсортированных по дате от новых к старым CURRENT
    ...
    //получение всех завершённых бронирований пользователя
    //отсортированных по дате от новых к старым PAST
    ...
    //получение всех текущих бронирований для всех вещей пользователя
    //отсортированных по дате от новых к старым CURRENT
    ...
    //получение всех завершённых бронирований для всех вещей пользователя
    //отсортированных по дате от новых к старым PAST
    ...
    //получение всех будущих бронирований для всех вещей пользователя
    //по дате от новых к старым FUTURE
    List<Booking> findAllByItemOwnerIdAndStartIsAfterOrderByStartDesc(
            long bookerId,
            LocalDateTime start,
            Pageable page);

    //получение всех бронирований для всех вещей пользователя
    //по статусу отсортированных по дате от новых к старым WAITING
